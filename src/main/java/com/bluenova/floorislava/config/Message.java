...
public enum Message {
    ...
    ACCEPT_UNKNOWN_PLAYER(12, Group.ACCEPT, null, "%PREFIX% %ACCEPTING_NAME% &cEither doesn't exist, or is offline!"),
    ACCEPT_SENDER_NOLOBBY(13, Group.ACCEPT, null, "%PREFIX% %ACCEPTING_NAME% &cisn't in a lobby!"),
    ACCEPT_NO_INVITE(14, Group.ACCEPT, null, "%PREFIX% %ACCEPTING_NAME% &cdidn't invite you!"),
    ACCEPT_SENDER(15, Group.ACCEPT, null, "%PREFIX% %RECIEVER_NAME% &aaccepted your invite to a game of &cThe floor is Lave&a!"),
    ...
    static final ArrayList<Message> lobbyMessages = new ArrayList<>();
    static final ArrayList<Message> gameMessages = new ArrayList<>();
    static final ArrayList<Message> acceptMessages = new ArrayList<>();
    static final ArrayList<Message> inviteMessages = new ArrayList<>();
    static final ArrayList<Message> playerMessages = new ArrayList<>();
    static final ArrayList<Message> utilityMessages = new ArrayList<>();
    ...
    public Message replacePrefix() {
        current = current.replace("%PREFIX%", Message.getPrefix());
        return this;
    }

    public Message replaceReceiver(String receiverName) {
        current = current.replace("%RECEIVER_NAME%", receiverName);
        return this;
    }

    public Message replaceSender(String senderName) {
        current = current.replace("%SENDER_NAME%", senderName);
        return this;
    }
    ...
    public ArrayList<Message> getLobbyMessages() {
        return lobbyMessages;
    }

    public ArrayList<Message> getGameMessages() {
        return gameMessages;
    }

    public ArrayList<Message> getAcceptMessages() {
        return acceptMessages;
    }

    public ArrayList<Message> getInviteMessages() {
        return inviteMessages;
    }

    public ArrayList<Message> getPlayerMessages() {
        return playerMessages;
    }

    public ArrayList<Message> getUtilityMessages() {
